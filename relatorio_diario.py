...
def _montar_analisador_ia() -> AIAnalyzer | None:
    ...
    return AIAnalyzer(
        ...
        deepseek_model=getattr(config, "DEEPSEEK_MODEL", "deepseek/deepseek-v4-flash:free"),
        deepseek_base_url=getattr(config, "DEEPSEEK_BASE_URL", "https://openrouter.ai/api/v1"),
    )
